...
export function getProductMetadata(productId) {
  switch (productId) {
    ...
    case "arch_audit":
      return {
        deliveryNote: "Your Architecture Audit is booked. Send your system details through the intake form and you will get a diagnosis within 12 hours.",
        ctaLabel: "Submit your system spec",
        deliverable: true,
