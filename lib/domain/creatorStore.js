...
async function ensureSchema() {
  ...
  // Migration for databases seeded before fileless digital offers were
  // prevented from being active. Keep a deliberately activated offer intact
  // once it has fulfillment configured, but withdraw the unsafe seeded row.
  await db.run(
    `UPDATE offers
     SET status = 'draft', updated_at = CURRENT_TIMESTAMP
     WHERE offer_id = 'ui-templates'
       AND creator_handle = 'priya-design'
       AND offer_type = 'digital_file'
       AND status = 'active'
